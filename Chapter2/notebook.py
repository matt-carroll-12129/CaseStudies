...
class Note: 
	...
	def __init__(self, memo, tags=''):
		''' Initialize a note with memo and optional space-separated tags. Automatically set the notes creation date and a unique id'''
		self.memo = memo
		self.tags = tags 
...
class Notebook: 
	''' Represent a collection of notes that can e tagged, modified, and searched.'''
	def __init__(self):
		''' Initialize an empty list as a notebook '''
		self.notes = []
